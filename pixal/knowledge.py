"""Offline-first knowledge vault for P.I.X.A.L.

The vault is intentionally independent from any LLM provider. It can answer
simple exact/keyword lookups locally today and can later back a local vector
index without changing P.I.X.A.L.'s identity or runtime API.
"""
